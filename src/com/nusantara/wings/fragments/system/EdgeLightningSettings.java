...
import com.nusantara.wings.UtilsThemes;
...
public class EdgeLightningSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final int accentColor = UtilsThemes.getThemeAccentColor(getContext());
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mDurationPref) {
            ...
            int accentColor = UtilsThemes.getThemeAccentColor(getContext());
